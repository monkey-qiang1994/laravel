	...
	<div class="content clearfix bgf5">
		<section class="user-center inner clearfix">
			<div class="user-content__box clearfix bgf">
				...
				<form action="/pay" class="shopcart-form__box">
					<table class="table table-bordered">
						...
						<tbody>
							<tr>
								<th scope="row">
									<label class="checked-label"><input type="checkbox"><i></i>
										<div class="img"><img src="/home/images/temp/M-003.jpg" alt="" class="cover"></div>
									</label>
								</th>
								<td>
							...
							<tr>
								<th scope="row">
									<label class="checked-label"><input type="checkbox"><i></i>
										<div class="img"><img src="/home/images/temp/S-005.jpg" alt="" class="cover"></div>
									</label>
								</th>
								<td>
							...
							<tr>
								<th scope="row">
									<label class="checked-label"><input type="checkbox"><i></i>
										<div class="img"><img src="/home/images/temp/M-007.jpg" alt="" class="cover"></div>
									</label>
								</th>
								<td>
