			...
			<div class="pull-right">
				<div class="user-content__box clearfix bgf">
					...
					<div class="port b-r50" id="crop-avatar">
						<div class="img"><img src="{{$data->pic}}" class="cover b-r50"></div>
					</div>
					<form action="/user/info/{{$data->user_id}}" method="post" class="user-setting__form" role="form" enctype="multipart/form-data">
						{{csrf_field()}}
						{{method_field('PUT')}}
						<div class="input-group user-form-group">
							<label class="input-group-addon">地址</label>
							<label><input type="text" class="form-control" name="address" placeholder="请填写地址" value="{{$data->address}}"></label>
						</div>
						<div class="input-group user-form-group">
